...
export const ChatSidebar = ({ isCollapsed, setIsCollapsed }: ChatSidebarProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="p-3 md:p-4">
        <div className={`flex items-center ${isCollapsed ? "justify-center" : "justify-between"} mb-6 md:mb-8`}>
          <MessageSquare className={`w-5 h-5 md:w-6 md:h-6 text-accent ${!isCollapsed && "mr-2"}`} />
          {!isCollapsed && <span className="font-semibold text-base md:text-lg">Chats</span>}
        </div>
